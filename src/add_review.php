...
$sql_book = "SELECT title FROM book WHERE book_id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $sql_insert = "INSERT INTO review (user_id, book_id, r_title, review, rating) VALUES (?, ?, ?, ?, ?)";
        $stmt_insert = $conn->prepare($sql_insert);
        $stmt_insert->bind_param('iissi', $user_id, $book_id, $review_title, $review_text, $rating);
