...
// Database connection for Windows system
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_profile'])) {
        ...
        $stmt_check->bind_param('sss', $u_name, $email, $user_id);
        $stmt_check->execute();
        ...
        if (empty($errors)) {
            ...
            $stmt_update->bind_param('ssss', $u_name, $email, $contact, $user_id);
    ...
    if (isset($_POST['change_password'])) {
        ...
        if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
            ...
            $stmt_pass->bind_param('s', $user_id);
            $stmt_pass->execute();
            ...
            if ($user_data && password_verify($current_password, $user_data['password'])) {
                ...
                $stmt_update_pass->bind_param('ss', $new_password_hash, $user_id);
