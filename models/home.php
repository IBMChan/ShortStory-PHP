...
<body>
    ...
    <ul>
        ...
        <li><a href="logout.php">Logout</a></li> <!-- Added Logout -->
    </ul>
    ...
    <div class="hero-content">
        <h1>Welcome to Short Story</h1>
        <p>Here, we believe every book opens a new door to the world, and we’re here to help you step through it. Whether you’re here to find your next read, share your literary journey, or connect with a community of readers, this is your space to grow and belong.</p>
        <!-- Updated button -->
        <a href="models/login.php" class="btn">Get Started</a>
    </div>
</section>
